...
#define BLUART_746_UART_BAUDRATE				230400
#define BLUART_746_UART_DATABITS				UART_DATA_8_BITS
#define BLUART_746_UART_PARITY					UART_PARITY_DISABLE
#define BLUART_746_UART_STOP_BITS				UART_STOP_BITS_1
#define BLUART_746_UART_FLOWCTRL				UART_HW_FLOWCTRL_DISABLE
#define BLUART_746_UART_FLOWCTRL_THRESHOLD		122

#define BLUART_779_UART_BAUDRATE				115200
#define BLUART_779_UART_DATABITS				UART_DATA_8_BITS
#define BLUART_779_UART_PARITY					UART_PARITY_DISABLE
#define BLUART_779_UART_STOP_BITS				UART_STOP_BITS_1
#define BLUART_779_UART_FLOWCTRL				UART_HW_FLOWCTRL_DISABLE
#define BLUART_779_UART_FLOWCTRL_THRESHOLD		122
